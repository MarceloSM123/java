...
public class Item {
	...
	public void imprimir() {
		System.out.println("Productos actuale: "+productosActuales);
		System.out.println("Productos devueltos: "+productosDevueltos);
		System.out.println("Productos vendidos: "+productosVendidos);
	}
	public void vender (int venta) {
		productosActuales=productosActuales-venta;
		productosVendidos=productosVendidos+venta;
	}
	
	public void devolver(int devolver) {
		productosDevueltos=devolver;
